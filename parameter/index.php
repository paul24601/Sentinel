                    ...
                    <div class="collapse show" id="collapseProductMachine">
                        <div class="row mb-3 row-cols-1 row-cols-sm-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="runNo" placeholder="Enter Run Number">
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="IRN" placeholder="Enter IRN">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="collapse show" id="collapseProductDetails">
                        <div class="row mb-3 row-cols-1 row-cols-md-3 row-cols-sm-2">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="mold-name" placeholder="Enter Mold Name">
                            </div>
                            <div class="col">
                    ...
                    <div class="collapse show" id="collapseEjectionParams">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="airBlowTimeB"
                        ...
                        <h4>
                            <a class="text-decoration-none" data-bs-toggle="collapse" href="#collapseCorePull"
                                role="button" aria-expanded="false" aria-controls="collapseCorePull">
                                Core Pull Settings
                                <i class="bi bi-chevron-down float-end"></i> <!-- Chevron icon -->
                            </a>
                        </h4>
                        ...
                        <div class="collapse show" id="collapsePersonnel">
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="adjuster"
                                        placeholder="Enter Adjuster Name" required>
                                </div>
                                <div class="col">
                        ...
                        <div class="collapse show" id="collapseAttachments">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <img id="imagePreview" src="" class="img-fluid border rounded"
