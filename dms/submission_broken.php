...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Database connections using centralized system
    try {
        $dms_conn = DatabaseManager::getConnection('sentinel_monitoring');
        $sensory_conn = DatabaseManager::getConnection('sentinel_sensory');
    } catch (Exception $e) {
        die("Database connection failed: " . $e->getMessage());
    }
